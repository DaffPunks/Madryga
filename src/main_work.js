...
var utf8 = {
     ...
     * Chars in range U+0080 - U+07FF are encoded in 2 chars, 
     * Chars in range U+0800 - U+FFFF in 3 chars
     * Takes (JavaScript) unicode string to be encoded as UTF-8
     ...
     * Takes UTF-8 string to be decoded back to Unicode
...
var base64 = {
     ...
     * @param {Boolean} Flag to indicate whether str is Unicode 
     *      string to be encoded to UTF8 before conversion to base64; otherwise
